...
class Student(APIView):
        ...
        request_body=openapi.Schema(
            ...
            properties={
                ...
                "degree": openapi.Schema(
                    type=openapi.TYPE_STRING, description="max length 100"
                ),
                "student_logo_64": openapi.Schema(
                    type=openapi.TYPE_STRING, description="base 64 image"
                ),
            },
        ),
        responses={
    ...
    def put(self, request, studentId, format=None):
        ...
        if int(studentId) != userStudentId:
            return Response(
                {"Forbidden": "Student does not belong to user"}, status=403
            )
