...
class University(APIView):
    ...
    def get(self, request, universityId):
        ...
        serializer = UniversitySerializer(university, fields=(
            "university_id", "university_name", "university_logo_64", "university_site_url"))
    ...
    def put(self, request, universityId, format=None):
        ...
        serializer = UniversitySerializer(university, data=request.data, fields=(
            "university_name", "university_logo_64", "university_site_url"))
