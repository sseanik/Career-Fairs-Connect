...
class Company(APIView):
    ...
    def get(self, request, companyId, format=None):
        ...
        serializer = CompanySerializer(company, fields=(
            "company_id", "company_name", "company_description", "company_webpage_url", "company_logo_64"))
    ...
    def put(self, request, companyId, format=None):
        ...
        serializer = CompanySerializer(company, data=request.data, fields=(
            "company_name", "company_description", "company_webpage_url", "company_logo_64"))
